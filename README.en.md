...
When running the FastAPI server directly, visiting `http://localhost:8000/`
automatically redirects you to the React frontend at
`http://localhost:5173`. Start it with `npm run dev`.
